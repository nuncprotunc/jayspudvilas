  ...
  footer: `
    <footer class="footer">
      ...
      <div class="footer-bottom">
        ...
        <p class="footer-meta"><span class="footer-meta-muted">Information only, not legal advice</span> &middot; <a href="#" class="footer-meta-muted" onclick="if(typeof resetAnalyticsConsent==='function')resetAnalyticsConsent();return false;">Cookie settings</a> &middot; <span class="footer-meta-muted">GlassCase™ is a <a href="https://search.ipaustralia.gov.au/trademarks/search/view/2622499" class="footer-meta-muted" target="_blank" rel="noopener">trade mark</a> of Jayden Spudvilas-Powell.</span></p>
      </div>
    </footer>
  `
};
